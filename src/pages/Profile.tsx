...
import { Search, Bell, Grid3X3, Mail, TrendingUp, User } from "lucide-react";
      ...
      <div className="flex max-w-6xl mx-auto">
        ...
        <div className="w-16 px-3 py-6">
          <div className="space-y-4">
            ...
            <button
              className="p-3 text-gray-400 hover:text-gray-600 rounded-lg"
        ...
        <div className="flex-1 px-6 py-6">
          <Card className="bg-white rounded-xl shadow-sm max-w-4xl">
            {/* Blue header section */}
